...
class GnssLioFactor : public gtsam::NoiseModelFactor4<gtsam::Rot3, gtsam::Vector6, gtsam::Rot3, gtsam::Vector6>
{
    public: 
        ...
        const gtsam::Vector3 &grav_, double dt_, Eigen::Matrix<double, 15, 15> covariance_, const gtsam::SharedNoiseModel& model) :
        ...
        rel_vel(rel_vel_), grav(grav_), dt(dt_), odo_weight(odo_weight_), covariance(covariance_) {
        }
