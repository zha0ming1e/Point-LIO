...
class GnssCpFactorNoR : public gtsam::NoiseModelFactor4<gtsam::Vector3, gtsam::Rot3, gtsam::Vector6, gtsam::Vector6>
{
    public: 
        GnssCpFactorNoR(gtsam::Key f1, gtsam::Key f2, gtsam::Key i1, gtsam::Key j1, bool invalid_lidar_, double values_[20], Eigen::Vector3d RTex2_, const gtsam::SharedNoiseModel& model) :
        gtsam::NoiseModelFactor4<gtsam::Vector3, gtsam::Rot3, gtsam::Vector6, gtsam::Vector6>(model, f1, f2, i1, j1) {
    ...
    private:
        Eigen::Vector3d sv_pos_bi, sv_pos_bj, sv_pos_pi, sv_pos_pj, Tex_imu_r, anc_local, RTex2;
